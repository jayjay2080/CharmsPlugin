...
public class StrongSoulBlessing extends CharmBase {

    public StrongSoulBlessing(Data data, Charms plugin, ConfigManager configManager) {
        super(data, plugin, configManager);
    }
    private final String curseName = data.charmStrings.get(7);
